            ...
            <div class="modal-dialog">
                ...
                <form method="POST" action="includes/hotelfunctions.php" accept-charset="UTF-8" class="login-form">
                    ...
                    <div class="login-block">
                        ...
                        <br>
                        <div class="small_loader" style="text-align:center;display:none"><img src="assets/mages/loader-small.gif"></div>
                                ...
                                <div class="tb_direct_inner_lft ">
                                    ...
                                    <div class="tb_direct_inner_lft2 ">
                                        ...
                                        <div class="tb_align">
                                            ...
                                            <span class="tb_arrow2 ng-binding"></span>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-1">
                                        <div class="direction switchButton" id="switchButton">
                                            <img src="http://saintmartinparibahan.com.bd/assets/images/dbarrw.png">
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        To
                        ...
                        <div class="tb_seats_lists">
                            <ul>
                                <?php foreach($user[1] as $room){ ?>
                                 ...
                                 <span class="tim_lft ng-binding"><?php echo $room["status"] ?></span>
                                            ...
                                            <div class="tb_seats_list5">
                                                <div class="tb_seats_list1_inner">
                                                    <p style="font-weight:600;font-size:15px;" class="ng-binding"></p>

                                                    <form action="includes/hotelfunctions.php" method="POST">
                                                        <input type="hidden" name="form" value="cancel">
                                                        <input type="hidden" name="book_id" value="<?php echo $room["id"] ?>">


                                                        <input class="view_seats" type="submit" value="cancel" name="cancel">
                                                    </form>
                                                        ...
                                                        <div class="seat_arragement_inner1">
                                                            <div class="ac-lft-main">
                                                                <div class="ac-lft-list order">
                                                                    <ul>
                                                                        <li>
                                                                            <div class="order_cnct_detail"><img src="http://saintmartinparibahan.com.bd/assets/images/available_seat.png"> Available Seat
                                                                            </div>
                                                                            <div class="order_contact_inf s">Seat(s): <span class="tb_fare seat_no">0</span></div>
                                                                            <input class="seat_nos" id="seat_nos1" type="hidden">
                                                                        </li>
                                                                        <li>
                                                                            <div class="order_cnct_detail"><img src="http://saintmartinparibahan.com.bd/assets/images/seat_select.png"> Selected Seat
                                                                            </div>
                                                                            <div class="order_contact_inf">Base Fare: <span class="tb_fare rate_bus ng-binding">  Rs.1500 </span>
                                                                            </div>
                                                                        </li>
                                                                        <li>
                                                                            <div class="order_cnct_detail"><img src="http://saintmartinparibahan.com.bd/assets/images/booked.png"> Booked
                                                                            </div>
